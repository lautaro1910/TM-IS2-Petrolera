...
import TranserObject.JefeDeArea;
import TranserObject.Supervisor;
...
public class TSBVentana extends javax.swing.JFrame {
    ...
    private void BotonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonIniciarSesionActionPerformed
      ...
      int op=0;
      if ((supLogin.getUsuario().equals(CampoUsuario.getText())) && (supLogin.getContraseña().equals(CampoPass.getText()))) {
    ...
    private void BotonRegistrarseMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonRegistrarseMousePressed
       // RegistrarAdminXprimeraVez registrar = new RegistrarAdminXprimeraVez(listaUsuarios);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TSBVentana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
